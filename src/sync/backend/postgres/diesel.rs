...
/// [`Diesel Postgres`](https://docs.rs/diesel/2.3.10/diesel/pg/struct.PgConnection.html) backend
...
impl DieselPostgresBackend {
    /// Creates a new [`Diesel Postgres`](https://docs.rs/diesel/2.3.10/diesel/pg/struct.PgConnection.html) backend
    /// # Example
    /// ```
