use db_pool::r#async::{DatabasePoolBuilderTrait, SqlxPostgresBackend};
...
async fn run_test(conn_pool: &PgPool) {
    query("INSERT INTO author (first_name, last_name) VALUES ($1, $2)")
        .bind("John")
        .bind("Doe")
        .execute(conn_pool)
        .await
